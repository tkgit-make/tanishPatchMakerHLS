...
#pragma HLS INLINE OFF
    ...
    for (int_type i = 0; i < static_cast<int>(wp_parameters[4][2][0]); ++i)
    {
...
void makePatches_ShadowQuilt_fromEdges(int_type stop, int_type ppl, bool leftRight, index_type &n_patches, SPACEPOINT_TYPE (&GDarray) [MAX_LAYERS][MAX_POINTS_FOR_DATASET],
...
//#pragma HLS ARRAY_RESHAPE variable=patches_parameters dim=0 complete
    ...
    #pragma HLS UNROLL
        ...
        for(int_type b = 0; b < GDn_points[a]; b++)
        {
#if SMALL_CIRCUIT == false
    #pragma HLS UNROLL
#endif
...
#pragma HLS INLINE OFF
    ...
    for (int_type j = 0; j < GDn_points[i]; j++)
    {
