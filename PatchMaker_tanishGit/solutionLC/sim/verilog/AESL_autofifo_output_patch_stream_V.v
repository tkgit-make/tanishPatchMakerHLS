...
module AESL_autofifo_output_patch_stream_V (
    clk,
    reset,
    if_empty_n,
    if_read,
...
//------------------------Parameter----------------------
localparam
	TV_IN	=	"../tv/cdatafile/c.MPSQ.autotvin_output_patch_stream_V.dat",
	TV_OUT	=	"../tv/rtldatafile/rtl.MPSQ.autotvout_output_patch_stream_V.dat";

//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 64;
parameter ADDR_WIDTH = 32'd 10;
parameter DEPTH = 32'd 480;
