; ModuleID = 'C:/Users/rapiduser/Desktop/tanishGitHub/tanishPatchMakerHLS/PatchMaker_tanishGit/solution4/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_makePatches_ShadowQuilt_fromEdges_ir(i32 %stop, i32 %ppl, i1 %leftRight, i32* %n_patches, [5 x [128 x i64]]* %GDarray, [5 x i32]* %GDn_points, [32 x [5 x [16 x i64]]]* %patches_superpoints) local_unnamed_addr #0 {
entry:
  ...
  call void @copy_in(i32* %n_patches, i32* nonnull align 512 %n_patches_copy, [5 x [128 x i64]]* %GDarray, [5 x [128 x i64]]* %GDarray_copy, [5 x i32]* %GDn_points, [5 x i32]* nonnull align 512 %GDn_points_copy, [32 x [5 x [16 x i64]]]* %patches_superpoints, [32 x [5 x i1024]]* %patches_superpoints_copy2)
  call void @apatb_makePatches_ShadowQuilt_fromEdges_hw(i32 %stop, i32 %ppl, i1 %leftRight, i32* %n_patches_copy, [5 x [128 x i64]]* %GDarray_copy, [5 x i32]* %GDn_points_copy, [32 x [5 x i1024]]* %patches_superpoints_copy2)
  call void @copy_out(i32* %n_patches, i32* nonnull align 512 %n_patches_copy, [5 x [128 x i64]]* %GDarray, [5 x [128 x i64]]* %GDarray_copy, [5 x i32]* %GDn_points, [5 x i32]* nonnull align 512 %GDn_points_copy, [32 x [5 x [16 x i64]]]* %patches_superpoints, [32 x [5 x i1024]]* %patches_superpoints_copy2)
...
; Function Attrs: argmemonly noinline
define internal void @copy_in(i32* readonly "orig.arg.no"="0", i32* noalias align 512 "orig.arg.no"="1", [5 x [128 x i64]]* readonly "orig.arg.no"="2", [5 x [128 x i64]]* noalias "orig.arg.no"="3", [5 x i32]* readonly "orig.arg.no"="4", [5 x i32]* noalias align 512 "orig.arg.no"="5", [32 x [5 x [16 x i64]]]* readonly "orig.arg.no"="6", [32 x [5 x i1024]]* noalias "orig.arg.no"="7") #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal void @copy_out(i32* "orig.arg.no"="0", i32* noalias readonly align 512 "orig.arg.no"="1", [5 x [128 x i64]]* "orig.arg.no"="2", [5 x [128 x i64]]* noalias readonly "orig.arg.no"="3", [5 x i32]* "orig.arg.no"="4", [5 x i32]* noalias readonly align 512 "orig.arg.no"="5", [32 x [5 x [16 x i64]]]* "orig.arg.no"="6", [32 x [5 x i1024]]* noalias readonly "orig.arg.no"="7") #4 {
entry:
...
declare void @apatb_makePatches_ShadowQuilt_fromEdges_hw(i32, i32, i1, i32*, [5 x [128 x i64]]*, [5 x i32]*, [32 x [5 x i1024]]*)

define void @makePatches_ShadowQuilt_fromEdges_hw_stub_wrapper(i32, i32, i1, i32*, [5 x [128 x i64]]*, [5 x i32]*, [32 x [5 x i1024]]*) #5 {
entry:
  %7 = alloca [32 x [5 x [16 x i64]]]
  call void @copy_out(i32* null, i32* %3, [5 x [128 x i64]]* null, [5 x [128 x i64]]* %4, [5 x i32]* null, [5 x i32]* %5, [32 x [5 x [16 x i64]]]* %7, [32 x [5 x i1024]]* %6)
  call void @makePatches_ShadowQuilt_fromEdges_hw_stub(i32 %0, i32 %1, i1 %2, i32* %3, [5 x [128 x i64]]* %4, [5 x i32]* %5, [32 x [5 x [16 x i64]]]* %7)
  call void @copy_in(i32* null, i32* %3, [5 x [128 x i64]]* null, [5 x [128 x i64]]* %4, [5 x i32]* null, [5 x i32]* %5, [32 x [5 x [16 x i64]]]* %7, [32 x [5 x i1024]]* %6)
  ret void
}

declare void @makePatches_ShadowQuilt_fromEdges_hw_stub(i32, i32, i1, i32*, [5 x [128 x i64]]*, [5 x i32]*, [32 x [5 x [16 x i64]]]*)
