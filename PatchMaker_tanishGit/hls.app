<project xmlns="com.autoesl.autopilot.project" name="PatchMaker_tanishGit" top="MPSQ">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <solutions xmlns="">
        ...
        <solution name="solutionTEST" status="inactive"/>
        <solution name="solutionSC" status="inactive"/>
        <solution name="solutionSC2" status="active"/>
    </solutions>
</project>
