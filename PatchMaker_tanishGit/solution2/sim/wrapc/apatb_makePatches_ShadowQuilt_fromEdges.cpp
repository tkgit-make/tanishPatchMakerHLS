...
extern "C" void makePatches_ShadowQuilt_fromEdges_hw_stub_wrapper(int, int, char, volatile void *, volatile void *, volatile void *, volatile void *);
...
sc_bv<64> __xlx_tmp_lv = ((long long*)__xlx_apatb_param_GDarray)[j];
  ...
  tcl_file.set_num(1920, &tcl_file.GDarray_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_GDarray, __xlx_sprintf_buffer.data());
}
...
__xlx_tmp_lv.range(191,128) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+2];
__xlx_tmp_lv.range(255,192) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+3];
__xlx_tmp_lv.range(319,256) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+4];
__xlx_tmp_lv.range(383,320) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+5];
__xlx_tmp_lv.range(447,384) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+6];
__xlx_tmp_lv.range(511,448) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+7];
__xlx_tmp_lv.range(575,512) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+8];
__xlx_tmp_lv.range(639,576) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+9];
__xlx_tmp_lv.range(703,640) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+10];
__xlx_tmp_lv.range(767,704) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+11];
__xlx_tmp_lv.range(831,768) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+12];
__xlx_tmp_lv.range(895,832) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+13];
__xlx_tmp_lv.range(959,896) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+14];
__xlx_tmp_lv.range(1023,960) = ((long long*)__xlx_apatb_param_patches_superpoints)[j*16+15];
  ...
  tcl_file.set_num(150, &tcl_file.patches_superpoints_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_patches_superpoints, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
makePatches_ShadowQuilt_fromEdges_hw_stub_wrapper(__xlx_apatb_param_stop, __xlx_apatb_param_ppl, __xlx_apatb_param_leftRight, __xlx_apatb_param_n_patches, __xlx_apatb_param_GDarray, __xlx_apatb_param_GDn_points, __xlx_apatb_param_patches_superpoints);
