...
set C_modelArgList {
	...
	{ GDarray int 64 unused {array 1920 { } 0 1 }  }
	{ GDn_points int 32 unused {array 5 { } 0 1 }  }
	{ patches_superpoints int 1024 unused {array 150 { } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "stop", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "stop","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "n_patches", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "n_patches","cData": "char","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ n_patches sc_out sc_lv 8 signal 3 } 
	...
	{ GDarray_address1 sc_out sc_lv 11 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_start", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "start", "bundle":{"name": "ap_start", "role": "default" }} , 
 	...
 	{ "name": "GDarray_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "GDarray", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	...
	GDarray { ap_memory {  { GDarray_address0 mem_address 1 11 }  { GDarray_ce0 mem_ce 1 1 }  { GDarray_we0 mem_we 1 1 }  { GDarray_d0 mem_din 1 64 }  { GDarray_q0 mem_dout 0 64 }  { GDarray_address1 MemPortADDR2 1 11 }  { GDarray_ce1 MemPortCE2 1 1 }  { GDarray_we1 MemPortWE2 1 1 }  { GDarray_d1 MemPortDIN2 1 64 }  { GDarray_q1 MemPortDOUT2 0 64 } } }
