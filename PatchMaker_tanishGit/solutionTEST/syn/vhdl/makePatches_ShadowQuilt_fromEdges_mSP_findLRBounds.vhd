...
entity makePatches_ShadowQuilt_fromEdges_mSP_findLRBounds is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of makePatches_ShadowQuilt_fromEdges_mSP_findLRBounds is 
...
attribute shreg_extract : string;
    ...
    signal add_ln1515_fu_145_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln1515_reg_298 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal icmp_ln1515_fu_151_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1515_reg_303 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1515_reg_303_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal lhs_reg_312 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln1517_fu_201_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal lbVal_2_fu_209_p3 : STD_LOGIC_VECTOR (63 downto 0);
    signal select_ln1523_fu_254_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal trunc_ln1519_cast_fu_156_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal sext_ln1511_fu_191_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln1517_fu_195_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ret_31_fu_217_p2 : STD_LOGIC_VECTOR (32 downto 0);
    signal tmp_145_fu_228_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal sub_ln180_1_fu_222_p2 : STD_LOGIC_VECTOR (32 downto 0);
    signal rbVal_1_fu_236_p3 : STD_LOGIC_VECTOR (32 downto 0);
    signal sext_ln1523_fu_244_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln1523_fu_248_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component makePatches_ShadowQuilt_fromEdges_mSP_findLRBounds_trapezoid_edges_V IS
    generic (
        DataWidth : INTEGER;
...
begin
    trapezoid_edges_V_U : component makePatches_ShadowQuilt_fromEdges_mSP_findLRBounds_trapezoid_edges_V
    generic map (
        DataWidth => 26,
        AddressRange => 5,
        AddressWidth => 3)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1515_reg_303 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                j_reg_76 <= add_ln1515_reg_298;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (icmp_ln1515_reg_303_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (icmp_ln1515_reg_303_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                left_bound_write_assign_reg_88 <= select_ln1517_fu_201_p3;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (icmp_ln1515_reg_303_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                right_bound_write_assign_reg_100 <= select_ln1523_fu_254_p3;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                add_ln1515_reg_298 <= add_ln1515_fu_145_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                icmp_ln1515_reg_303 <= icmp_ln1515_fu_151_p2;
                icmp_ln1515_reg_303_pp0_iter1_reg <= icmp_ln1515_reg_303;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1515_reg_303 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    add_ln1515_fu_145_p2 <= std_logic_vector(unsigned(ap_phi_mux_j_phi_fu_80_p4) + unsigned(ap_const_lv32_1));
    ...
    ap_condition_pp0_flush_enable_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln1515_fu_151_p2, ap_block_pp0_stage0_subdone)
    begin
        if (((icmp_ln1515_fu_151_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_phi_mux_j_phi_fu_80_p4_assign_proc : process(j_reg_76, ap_CS_fsm_pp0_stage0, add_ln1515_reg_298, icmp_ln1515_reg_303, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
        if (((icmp_ln1515_reg_303 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
            ap_phi_mux_j_phi_fu_80_p4 <= add_ln1515_reg_298;
        else 
    ...
    icmp_ln1515_fu_151_p2 <= "1" when (ap_phi_mux_j_phi_fu_80_p4 = row_list_size) else "0";
    icmp_ln1517_fu_195_p2 <= "1" when (signed(sext_ln1511_fu_191_p1) < signed(lbVal_reg_124)) else "0";
    icmp_ln1523_fu_248_p2 <= "1" when (signed(sext_ln1523_fu_244_p1) < signed(rbVal_reg_112)) else "0";
    idxprom1_fu_136_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i),64));
    lbVal_1_fu_183_p3 <= 
        sub_ln180_fu_169_p2 when (tmp_fu_175_p3(0) = '1') else 
        ret_fu_164_p2;
    lbVal_2_fu_209_p3 <= 
        sext_ln1511_fu_191_p1 when (icmp_ln1517_fu_195_p2(0) = '1') else 
        lbVal_reg_124;
    rbVal_1_fu_236_p3 <= 
        sub_ln180_1_fu_222_p2 when (tmp_145_fu_228_p3(0) = '1') else 
        ret_31_fu_217_p2;
    rbVal_2_fu_262_p3 <= 
        sext_ln1523_fu_244_p1 when (icmp_ln1523_fu_248_p2(0) = '1') else 
        rbVal_reg_112;
    ret_31_fu_217_p2 <= std_logic_vector(signed(sext_ln215_fu_161_p1) - signed(rhs_reg_292));
    ...
    row_list_address0 <= trunc_ln1519_cast_fu_156_p1(8 - 1 downto 0);
    ...
    select_ln1517_fu_201_p3 <= 
        j_reg_76_pp0_iter1_reg when (icmp_ln1517_fu_195_p2(0) = '1') else 
        left_bound_write_assign_reg_88;
    select_ln1523_fu_254_p3 <= 
        j_reg_76_pp0_iter1_reg when (icmp_ln1523_fu_248_p2(0) = '1') else 
        right_bound_write_assign_reg_100;
        sext_ln1511_fu_191_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(lbVal_1_fu_183_p3),64));

        sext_ln1523_fu_244_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(rbVal_1_fu_236_p3),64));

        sext_ln215_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(lhs_reg_312),33));

    sub_ln180_1_fu_222_p2 <= std_logic_vector(unsigned(ap_const_lv33_0) - unsigned(ret_31_fu_217_p2));
    sub_ln180_fu_169_p2 <= std_logic_vector(unsigned(ap_const_lv33_0) - unsigned(ret_fu_164_p2));
    tmp_145_fu_228_p3 <= ret_31_fu_217_p2(32 downto 32);
    ...
    trunc_ln1519_cast_fu_156_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_phi_mux_j_phi_fu_80_p4),64));
end behav;
