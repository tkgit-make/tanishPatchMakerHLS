...
set C_modelArgList {
	...
	{ patches_parameters417 int 3 regular {array 32 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "patches_superpoints_0", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "patches_parameters417", "interface" : "memory", "bitwidth" : 3, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ patches_parameters417_d0 sc_out sc_lv 3 signal 124 } 
...
set Spec2ImplPortList { 
	...
	patches_parameters417 { ap_memory {  { patches_parameters417_address0 mem_address 1 5 }  { patches_parameters417_ce0 mem_ce 1 1 }  { patches_parameters417_we0 mem_we 1 1 }  { patches_parameters417_d0 mem_din 1 3 } } }
