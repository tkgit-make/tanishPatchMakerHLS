...
set ID 97
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_init_patch_V_0
...
set ID 98
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_NPpatches_superpoints_0_V
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 32
...
set ID 99
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_NPpatches_parameters_V_0
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 24
...
set ID 100
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_NPpatches_parameters_V_1
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 1
set AddrRange 24
...
set ID 101
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_NPpatches_parameters_V_2
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 24
