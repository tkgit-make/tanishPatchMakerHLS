...
set id 136
set name makePatches_ShadowQuilt_fromEdges_mux_42_32_1_1
...
set id 138
set name makePatches_ShadowQuilt_fromEdges_mul_33s_64s_64_1_1
...
set ID 144
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_solveComplmentaryPatch_new_z_i_V
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 5
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { patches_parameters_address0 { O 12 vector } patches_parameters_ce0 { O 1 bit } patches_parameters_we0 { O 1 bit } patches_parameters_d0 { O 32 vector } patches_parameters_q0 { I 32 vector } patches_parameters_address1 { O 12 vector } patches_parameters_ce1 { O 1 bit } patches_parameters_q1 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { nPatchesAtOriginal { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { previous_z_top_min_read { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { z_top_min_read { I 32 vector } } \
} "
}
