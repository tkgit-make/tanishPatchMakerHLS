...
set C_modelArgList {
	{ patches_superpoints_0 int 64 regular {array 160 { 1 1 } 1 1 }  }
	{ wsp1 int 8 regular  }
	{ wsp11 int 3 regular  }
	{ wsp2 int 8 regular  }
	{ wsp22 int 3 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "patches_superpoints_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "wsp22", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "wsp22", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "wsp22", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "wsp22", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_64s_64_4_no_dsp_1_U6399", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_11ns_4ns_3_15_1_U6400", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.urem_11ns_4ns_3_15_1_U6401", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_14ns_16ns_29_4_1_U6402", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_14ns_16ns_29_4_1_U6403", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	areWedgeSuperPointsEqual {
		patches_superpoints_0 {Type I LastRead 22 FirstWrite -1}
		wsp1 {Type I LastRead 0 FirstWrite -1}
		wsp11 {Type I LastRead 0 FirstWrite -1}
		wsp2 {Type I LastRead 0 FirstWrite -1}
		wsp22 {Type I LastRead 0 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	patches_superpoints_0 { ap_memory {  { patches_superpoints_0_address0 mem_address 1 8 }  { patches_superpoints_0_ce0 mem_ce 1 1 }  { patches_superpoints_0_q0 mem_dout 0 64 }  { patches_superpoints_0_address1 MemPortADDR2 1 8 }  { patches_superpoints_0_ce1 MemPortCE2 1 1 }  { patches_superpoints_0_q1 MemPortDOUT2 0 64 } } }
	wsp1 { ap_none {  { wsp1 in_data 0 8 } } }
	wsp11 { ap_none {  { wsp11 in_data 0 3 } } }
	wsp2 { ap_none {  { wsp2 in_data 0 8 } } }
	wsp22 { ap_none {  { wsp22 in_data 0 3 } } }
}
