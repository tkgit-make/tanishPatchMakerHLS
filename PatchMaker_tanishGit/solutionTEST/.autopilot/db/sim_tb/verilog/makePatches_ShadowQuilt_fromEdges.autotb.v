...
`define AUTOTB_TVIN_GDn_points_0  "./c.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_0.dat"
`define AUTOTB_TVIN_GDn_points_1  "./c.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_1.dat"
`define AUTOTB_TVIN_GDn_points_2  "./c.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_2.dat"
`define AUTOTB_TVIN_GDn_points_3  "./c.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_3.dat"
`define AUTOTB_TVIN_GDn_points_4  "./c.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_4.dat"
...
`define AUTOTB_TVIN_GDn_points_0_out_wrapc  "./rtl.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_0.dat"
`define AUTOTB_TVIN_GDn_points_1_out_wrapc  "./rtl.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_1.dat"
`define AUTOTB_TVIN_GDn_points_2_out_wrapc  "./rtl.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_2.dat"
`define AUTOTB_TVIN_GDn_points_3_out_wrapc  "./rtl.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_3.dat"
`define AUTOTB_TVIN_GDn_points_4_out_wrapc  "./rtl.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points_4.dat"
