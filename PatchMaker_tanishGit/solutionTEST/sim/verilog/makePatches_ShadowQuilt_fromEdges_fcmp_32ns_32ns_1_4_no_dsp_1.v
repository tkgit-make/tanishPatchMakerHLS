...
module makePatches_ShadowQuilt_fromEdges_fcmp_32ns_32ns_1_4_no_dsp_1
#(parameter
    ID         = 288,
    NUM_STAGE  = 4,
    din0_WIDTH = 32,
...
//------------------------Instantiation------------------
makePatches_ShadowQuilt_fromEdges_ap_fcmp_2_no_dsp_32 makePatches_ShadowQuilt_fromEdges_ap_fcmp_2_no_dsp_32_u (
    .aclk                    ( aclk ),
    .aclken                  ( aclken ),
