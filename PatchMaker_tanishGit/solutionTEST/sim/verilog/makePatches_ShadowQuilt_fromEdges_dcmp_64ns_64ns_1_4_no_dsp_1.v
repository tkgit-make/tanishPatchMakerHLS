...
module makePatches_ShadowQuilt_fromEdges_dcmp_64ns_64ns_1_4_no_dsp_1
#(parameter
    ID         = 5,
    NUM_STAGE  = 4,
    din0_WIDTH = 64,
...
//------------------------Instantiation------------------
makePatches_ShadowQuilt_fromEdges_ap_dcmp_2_no_dsp_64 makePatches_ShadowQuilt_fromEdges_ap_dcmp_2_no_dsp_64_u (
    .aclk                    ( aclk ),
    .aclken                  ( aclken ),
