...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         ...
         "c.makePatches_ShadowQuilt_fromEdges.autotvin_patches_superpoints.dat"
         "c.makePatches_ShadowQuilt_fromEdges.autotvout_n_patches.dat"
         "c.makePatches_ShadowQuilt_fromEdges.autotvout_patches_superpoints.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         ...
         "rtl.makePatches_ShadowQuilt_fromEdges.autotvout_patches_superpoints.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
