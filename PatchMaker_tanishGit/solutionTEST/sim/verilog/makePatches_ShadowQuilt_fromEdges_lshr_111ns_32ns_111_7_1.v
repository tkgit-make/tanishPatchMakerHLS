...
module makePatches_ShadowQuilt_fromEdges_lshr_111ns_32ns_111_7_1
#(parameter
    ID = 1,             // core ID, unused in RTL
    din0_WIDTH = 111,   // data bitwidth
    din1_WIDTH = 111,     // shift control bitwidth
    dout_WIDTH = 111,   // output bitwidth
