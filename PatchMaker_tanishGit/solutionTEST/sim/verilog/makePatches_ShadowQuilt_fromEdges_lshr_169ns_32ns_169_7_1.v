...
module makePatches_ShadowQuilt_fromEdges_lshr_169ns_32ns_169_7_1
#(parameter
    ID = 1,             // core ID, unused in RTL
    din0_WIDTH = 169,   // data bitwidth
    din1_WIDTH = 169,     // shift control bitwidth
    dout_WIDTH = 169,   // output bitwidth
