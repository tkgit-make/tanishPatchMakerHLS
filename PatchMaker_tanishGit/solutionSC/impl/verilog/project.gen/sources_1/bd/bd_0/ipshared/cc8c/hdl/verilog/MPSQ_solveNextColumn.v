...
wire   [0:0] icmp_ln646_fu_242_p2;
reg   [0:0] icmp_ln646_reg_303;
wire    ap_CS_fsm_state2;
wire   [31:0] select_ln648_fu_254_p3;
...
wire   [0:0] icmp_ln666_fu_268_p2;
reg   [0:0] icmp_ln666_reg_333;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state68_on_subcall_done) & (1'b1 == ap_CS_fsm_state68) & ((icmp_ln666_reg_333 == 1'd1) | (tmp_reg_324 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state1) & (1'b1 == ap_NS_fsm_state2) & (icmp_ln646_fu_242_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b0 == ap_block_state68_on_subcall_done) & (1'b1 == ap_CS_fsm_state68) & (icmp_ln666_reg_333 == 1'd0) & (tmp_reg_324 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b0 == ap_block_state68_on_subcall_done) & (1'b1 == ap_CS_fsm_state68) & (icmp_ln666_reg_333 == 1'd1) & (tmp_reg_324 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln646_reg_303 == 1'd1))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b0 == ap_block_state68_on_subcall_done) & (1'b1 == ap_CS_fsm_state68) & ((icmp_ln666_reg_333 == 1'd1) | (tmp_reg_324 == 1'd0))))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state68) & (icmp_ln666_reg_333 == 1'd1) & (tmp_reg_324 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln646_reg_303 == 1'd1))) begin
...
assign icmp_ln646_fu_242_p2 = ((n_patches_i == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln666_fu_268_p2 = (($signed(loopCounter_reg_167) > $signed(32'd25)) ? 1'b1 : 1'b0);
...
assign select_ln648_fu_254_p3 = ((icmp_ln878_fu_248_p2[0:0] == 1'b1) ? 32'd50000000 : grp_straightLineProjectorFromLayerIJtoK_fu_216_ap_return);
