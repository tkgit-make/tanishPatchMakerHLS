...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("patches_superpoints_address0", 12, hls_out, 6, "ap_memory", "mem_address", 1),
	...
	Port_Property("patches_superpoints_d0", 64, hls_out, 6, "ap_memory", "mem_din", 1),
	Port_Property("patches_superpoints_q0", 64, hls_in, 6, "ap_memory", "mem_dout", 1),
	Port_Property("patches_superpoints_address1", 12, hls_out, 6, "ap_memory", "MemPortADDR2", 1),
	Port_Property("patches_superpoints_ce1", 1, hls_out, 6, "ap_memory", "MemPortCE2", 1),
	Port_Property("patches_superpoints_q1", 64, hls_in, 6, "ap_memory", "MemPortDOUT2", 1),
};
