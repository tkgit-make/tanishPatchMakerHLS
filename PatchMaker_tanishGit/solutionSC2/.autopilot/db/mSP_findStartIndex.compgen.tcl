...
set id 18
set name MPSQ_dcmp_64ns_64ns_1_2_no_dsp_1
...
set id 19
set name MPSQ_sitodp_64s_64_4_no_dsp_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row_list \
    op interface \
    ports { row_list_address0 { O 8 vector } row_list_ce0 { O 1 bit } row_list_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_list'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_row_list_size \
    op interface \
    ports { row_list_size { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { projectionToRow { I 34 vector } } \
} "
}
