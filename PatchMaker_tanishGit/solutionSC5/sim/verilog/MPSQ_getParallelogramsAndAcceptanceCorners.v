...
wire   [0:0] icmp_ln878_13_fu_394_p2;
...
wire   [0:0] icmp_ln878_15_fu_697_p2;
wire   [31:0] b_corner_min_V_3_fu_711_p6;
wire   [0:0] icmp_ln878_16_fu_725_p2;
...
wire   [0:0] icmp_ln878_14_fu_889_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln92_fu_625_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln61_fu_450_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        a_corner_min_V_1_reg_313 <= a_corner_min_V_fu_70;
    end else if (((1'b1 == ap_CS_fsm_state6) & (icmp_ln92_fu_625_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln61_fu_450_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'b0 == ap_block_state5_on_subcall_done) & (trunc_ln73_reg_1249 == 2'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'b0 == ap_block_state5_on_subcall_done) & (trunc_ln73_reg_1249 == 2'd2))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'b0 == ap_block_state5_on_subcall_done) & (trunc_ln73_reg_1249 == 2'd3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state5) & (1'b0 == ap_block_state5_on_subcall_done) & (trunc_ln73_reg_1249 == 2'd0))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b0)) | ((1'b1 == ap_CS_fsm_state6) & (icmp_ln92_fu_625_p2 == 1'd1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign a_corner_min_V_4_fu_703_p3 = ((icmp_ln878_15_fu_697_p2[0:0] == 1'b1) ? tmp_fu_683_p6 : a_corner_min_V_1_reg_313);

assign add_ln66_fu_456_p2 = (i_reg_250 + 3'd1);

assign add_ln92_fu_619_p2 = (i_3_reg_275 + 3'd1);
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((grp_straightLineProjectorFromLayerIJtoK_fu_362_ap_done == 1'b0) | (grp_straightLineProjectorFromLayerIJtoK_fu_348_ap_done == 1'b0) | (grp_straightLineProjectorFromLayerIJtoK_fu_335_ap_done == 1'b0) | (grp_straightLineProjectorFromLayerIJtoK_fu_322_ap_done == 1'b0));
end

always @ (*) begin
    ap_condition_944 = (~(ap_phi_mux_i_phi_fu_254_p4 == 3'd1) & ~(ap_phi_mux_i_phi_fu_254_p4 == 3'd3) & ~(ap_phi_mux_i_phi_fu_254_p4 == 3'd2));
end

assign ap_phi_mux_i_phi_fu_254_p4 = i_reg_250;

assign b_corner_min_V_6_fu_895_p3 = ((icmp_ln878_14_fu_889_p2[0:0] == 1'b1) ? select_ln145_fu_873_p3 : b_corner_min_V_1_reg_304);

assign b_corner_min_V_7_fu_731_p3 = ((icmp_ln878_16_fu_725_p2[0:0] == 1'b1) ? b_corner_min_V_3_fu_711_p6 : b_corner_min_V_1_reg_304);

assign c_corner_max_V_4_fu_759_p3 = ((icmp_ln886_9_fu_753_p2[0:0] == 1'b1) ? tmp_s_fu_739_p6 : c_corner_max_V_1_reg_295);

assign d_corner_max_V_6_fu_903_p3 = ((icmp_ln878_14_fu_889_p2[0:0] == 1'b1) ? select_ln145_fu_873_p3 : d_corner_max_V_1_reg_286);
...
assign icmp_ln878_13_fu_394_p2 = (($signed(p_read1) < $signed(32'd22000100)) ? 1'b1 : 1'b0);

assign icmp_ln878_14_fu_889_p2 = (($signed(b_corner_min_V_1_reg_304) < $signed(d_corner_max_V_1_reg_286)) ? 1'b1 : 1'b0);

assign icmp_ln878_15_fu_697_p2 = (($signed(tmp_fu_683_p6) < $signed(a_corner_min_V_1_reg_313)) ? 1'b1 : 1'b0);

assign icmp_ln878_16_fu_725_p2 = (($signed(b_corner_min_V_3_fu_711_p6) < $signed(b_corner_min_V_1_reg_304)) ? 1'b1 : 1'b0);
...
assign icmp_ln92_fu_625_p2 = ((i_3_reg_275 == 3'd4) ? 1'b1 : 1'b0);

assign or_ln152_fu_911_p2 = (icmp_ln886_11_fu_867_p2 | icmp_ln878_14_fu_889_p2);
...
assign trunc_ln878_fu_679_p1 = i_3_reg_275[1:0];

assign z1_max_V_fu_400_p3 = ((icmp_ln878_13_fu_394_p2[0:0] == 1'b1) ? p_read1 : 32'd22000100);
