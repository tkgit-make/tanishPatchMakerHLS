...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "MPSQ.autotvin.dat"
	set constFileTvOut       "MPSQ.autotvout.dat"
	set constFileHdlTvIn     "MPSQ.autohdltvin.dat"
	set constFileHdlTvOut    "MPSQ.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
