...
set ID 555
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_2_NPpatches_parameters_2
...
set ID 556
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_2_NPpatches_parameters_3
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 1
set AddrRange 24
...
set ID 557
set hasByteEnable 0
set MemName makePatches_ShadowQuilt_fromEdges_makePatch_alignedToLine_2_NPpatches_parameters_1
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 1
set AddrRange 24
