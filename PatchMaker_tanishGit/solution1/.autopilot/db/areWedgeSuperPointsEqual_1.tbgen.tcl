set moduleName areWedgeSuperPointsEqual_1
set isTopModule 0
...
set C_modelName {areWedgeSuperPointsEqual.1}
set C_modelType { int 1 }
set C_modelArgList {
	{ patches_superpoints_31 int 64 regular {array 720 { 1 1 } 1 1 }  }
	{ patches_superpoints_30 int 64 regular {array 720 { 1 1 } 1 1 }  }
	{ wsp1 int 3 regular  }
	{ wsp2 int 3 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "patches_superpoints_31", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "patches_superpoints_30", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "wsp1", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	{ "Name" : "wsp2", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ patches_superpoints_30_address0 sc_out sc_lv 10 signal 1 } 
	{ patches_superpoints_30_ce0 sc_out sc_logic 1 signal 1 } 
	{ patches_superpoints_30_q0 sc_in sc_lv 64 signal 1 } 
	{ patches_superpoints_30_address1 sc_out sc_lv 10 signal 1 } 
	{ patches_superpoints_30_ce1 sc_out sc_logic 1 signal 1 } 
	{ patches_superpoints_30_q1 sc_in sc_lv 64 signal 1 } 
	{ wsp1 sc_in sc_lv 3 signal 2 } 
	{ wsp2 sc_in sc_lv 3 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "wsp2", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "wsp2", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_64ns_64_2_no_dsp_1_U173", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_64ns_64_2_no_dsp_1_U174", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	patches_superpoints_30 { ap_memory {  { patches_superpoints_30_address0 mem_address 1 10 }  { patches_superpoints_30_ce0 mem_ce 1 1 }  { patches_superpoints_30_q0 mem_dout 0 64 }  { patches_superpoints_30_address1 MemPortADDR2 1 10 }  { patches_superpoints_30_ce1 MemPortCE2 1 1 }  { patches_superpoints_30_q1 MemPortDOUT2 0 64 } } }
