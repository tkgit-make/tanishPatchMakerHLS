...
set C_modelArgList {
	...
	{ patches_superpoints_30 int 64 regular {array 240 { 1 1 } 1 1 }  }
	{ wsp1 int 3 regular  }
	{ wsp2 int 3 regular  }
}
...
set portList { 
	...
	{ patches_superpoints_30_address0 sc_out sc_lv 8 signal 1 } 
	{ patches_superpoints_30_ce0 sc_out sc_logic 1 signal 1 } 
	{ patches_superpoints_30_q0 sc_in sc_lv 64 signal 1 } 
	{ patches_superpoints_30_address1 sc_out sc_lv 8 signal 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_64ns_64_2_no_dsp_1_U225", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sitodp_64ns_64_2_no_dsp_1_U226", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	patches_superpoints_30 { ap_memory {  { patches_superpoints_30_address0 mem_address 1 8 }  { patches_superpoints_30_ce0 mem_ce 1 1 }  { patches_superpoints_30_q0 mem_dout 0 64 }  { patches_superpoints_30_address1 MemPortADDR2 1 8 }  { patches_superpoints_30_ce1 MemPortCE2 1 1 }  { patches_superpoints_30_q1 MemPortDOUT2 0 64 } } }
