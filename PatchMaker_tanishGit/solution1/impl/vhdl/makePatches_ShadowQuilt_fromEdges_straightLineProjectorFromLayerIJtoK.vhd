...
attribute shreg_extract : string;
    ...
    signal icmp_ln105_fu_157_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln105_reg_563 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln113_fu_174_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln113_reg_573 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln121_fu_191_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln121_reg_583 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln111_fu_169_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln119_fu_186_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln127_fu_203_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_147_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_150_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln111_fu_163_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal empty_fu_153_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln119_fu_180_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln127_fu_197_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal zext_ln103_fu_237_p1 : STD_LOGIC_VECTOR (25 downto 0);
    signal zext_ln101_fu_215_p1 : STD_LOGIC_VECTOR (25 downto 0);
    signal sub_ln130_fu_241_p2 : STD_LOGIC_VECTOR (25 downto 0);
    signal zext_ln102_fu_226_p1 : STD_LOGIC_VECTOR (25 downto 0);
    signal sub_ln130_1_fu_252_p2 : STD_LOGIC_VECTOR (25 downto 0);
    ...
    signal add_ln132_fu_541_p2 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U42 : component makePatches_ShadowQuilt_fromEdges_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U43 : component makePatches_ShadowQuilt_fromEdges_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fdiv_32ns_32ns_32_6_no_dsp_1_U44 : component makePatches_ShadowQuilt_fromEdges_fdiv_32ns_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_64ns_32_2_no_dsp_1_U45 : component makePatches_ShadowQuilt_fromEdges_sitofp_64ns_32_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    sitofp_64ns_32_2_no_dsp_1_U46 : component makePatches_ShadowQuilt_fromEdges_sitofp_64ns_32_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    sitofp_32s_32_2_no_dsp_1_U47 : component makePatches_ShadowQuilt_fromEdges_sitofp_32s_32_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    sitofp_32s_32_2_no_dsp_1_U48 : component makePatches_ShadowQuilt_fromEdges_sitofp_32s_32_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln105_reg_563 <= icmp_ln105_fu_157_p2;
                icmp_ln113_reg_573 <= icmp_ln113_fu_174_p2;
                icmp_ln121_reg_583 <= icmp_ln121_fu_191_p2;
    ...
    add_ln111_fu_163_p2 <= std_logic_vector(unsigned(i) + unsigned(ap_const_lv3_7));
    add_ln119_fu_180_p2 <= std_logic_vector(unsigned(empty_fu_153_p1) + unsigned(ap_const_lv3_7));
    add_ln127_fu_197_p2 <= std_logic_vector(unsigned(k) + unsigned(ap_const_lv3_7));
    add_ln132_fu_541_p2 <= std_logic_vector(unsigned(result_V_fu_394_p3) + unsigned(z_i_read_reg_557_pp0_iter10_reg));
    ...
    ap_return <= std_logic_vector(unsigned(add_ln132_fu_541_p2) - unsigned(result_V_7_fu_533_p3));
    ...
    begin
        ...
        grp_fu_147_p0 <= std_logic_vector(IEEE.numeric_std.resize(signed(sub_ln130_fu_241_p2),32));
    ...
    begin
        ...
        grp_fu_150_p0 <= std_logic_vector(IEEE.numeric_std.resize(signed(sub_ln130_1_fu_252_p2),32));

    icmp_ln105_fu_157_p2 <= "1" when (i = ap_const_lv3_0) else "0";
    icmp_ln113_fu_174_p2 <= "1" when (j = ap_const_lv32_0) else "0";
    icmp_ln121_fu_191_p2 <= "1" when (k = ap_const_lv3_0) else "0";
    ...
    radii_address0 <= zext_ln127_fu_203_p1(3 - 1 downto 0);
    radii_address1 <= zext_ln119_fu_186_p1(3 - 1 downto 0);
    radii_address2 <= zext_ln111_fu_169_p1(3 - 1 downto 0);
    ...
    radius_i_1_fu_208_p3 <= 
        ap_const_lv25_0 when (icmp_ln105_reg_563(0) = '1') else 
        radii_q2;
    radius_j_1_fu_219_p3 <= 
        ap_const_lv25_0 when (icmp_ln113_reg_573(0) = '1') else 
        radii_q1;
    radius_k_1_fu_230_p3 <= 
        ap_const_lv25_0 when (icmp_ln121_reg_583(0) = '1') else 
        radii_q0;
    ...
    sub_ln130_1_fu_252_p2 <= std_logic_vector(unsigned(zext_ln102_fu_226_p1) - unsigned(zext_ln101_fu_215_p1));
    sub_ln130_fu_241_p2 <= std_logic_vector(unsigned(zext_ln103_fu_237_p1) - unsigned(zext_ln101_fu_215_p1));
    ...
    val_fu_380_p3 <= 
        ...
        tmp_1_fu_370_p4;
    zext_ln101_fu_215_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(radius_i_1_fu_208_p3),26));
    zext_ln102_fu_226_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(radius_j_1_fu_219_p3),26));
    zext_ln103_fu_237_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(radius_k_1_fu_230_p3),26));
    zext_ln111_fu_169_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln111_fu_163_p2),64));
    zext_ln119_fu_186_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln119_fu_180_p2),64));
    zext_ln127_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln127_fu_197_p2),64));
