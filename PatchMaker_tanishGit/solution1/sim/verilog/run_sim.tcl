...
set ret [catch {eval exec ./cosim.tv.exe verbose | tee temp0.log >&@ stdout} err]
...
if {[file isfile makePatches_ShadowQuilt_fromEdges.autotvin.dat]} {
	file delete -force makePatches_ShadowQuilt_fromEdges.autotvin.dat
}

if {[file isfile makePatches_ShadowQuilt_fromEdges.autotvout.dat]} {
	file delete -force makePatches_ShadowQuilt_fromEdges.autotvout.dat
}
...
set ret [catch {eval exec ./cosim.pc.exe verbose | tee temp0.log >&@ stdout} err]
