...
module AESL_automem_GDn_points (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.makePatches_ShadowQuilt_fromEdges.autotvin_GDn_points.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.makePatches_ShadowQuilt_fromEdges.autotvout_GDn_points.dat"; 
//------------------------Local signal-------------------
