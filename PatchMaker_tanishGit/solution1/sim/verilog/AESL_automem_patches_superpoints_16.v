...
module AESL_automem_patches_superpoints_16 (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.makePatches_ShadowQuilt_fromEdges.autotvin_patches_superpoints_16.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.makePatches_ShadowQuilt_fromEdges.autotvout_patches_superpoints_16.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 64;
parameter ADDR_WIDTH = 32'd 10;
parameter DEPTH = 32'd 720;
parameter DLY = 0.1;
