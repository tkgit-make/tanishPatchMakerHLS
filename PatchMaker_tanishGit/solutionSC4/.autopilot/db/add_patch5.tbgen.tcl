...
set C_modelName {add_patch5}
set C_modelType { void 0 }
set C_modelArgList {
	{ n_patches int 8 regular {pointer 1}  }
	{ n_patches_read int 8 regular  }
	{ wp_superpoints int 32 regular {array 160 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ patches_superpoints_d0 sc_out sc_lv 32 signal 4 } 
	{ patches_superpoints_q0 sc_in sc_lv 32 signal 4 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_encodeCoordinates_fu_473", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	wp_superpoints { ap_memory {  { wp_superpoints_address0 mem_address 1 8 }  { wp_superpoints_ce0 mem_ce 1 1 }  { wp_superpoints_q0 mem_dout 0 32 } } }
