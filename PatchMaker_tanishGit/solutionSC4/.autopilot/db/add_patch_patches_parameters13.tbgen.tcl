set moduleName add_patch_patches_parameters13
set isTopModule 0
...
set C_modelName {add_patch_patches_parameters13}
...
set portList { 
	...
	{ patches_parameters_q0 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
