set moduleName makeSuperPoint_alignedToLine7
set isTopModule 0
...
set C_modelName {makeSuperPoint_alignedToLine7}
...
set portList { 
	...
	{ original_ppl sc_in sc_lv 32 signal 3 } 
	{ init_patch_address0 sc_out sc_lv 8 signal 4 } 
	{ init_patch_ce0 sc_out sc_logic 1 signal 4 } 
	{ init_patch_we0 sc_out sc_logic 1 signal 4 } 
	{ init_patch_d0 sc_out sc_lv 32 signal 4 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "6"],
		...
		"Port" : [
			...
			{"Name" : "trapezoid_edges_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_mSP_findLRBounds_fu_276", "Port" : "trapezoid_edges_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.radiiDivisionList_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.row_list_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mSP_findStartIndex_fu_268", "Parent" : "0",
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_mSP_findLRBounds_fu_276", "Parent" : "0", "Child" : ["5"],
		...
		"Port" : [
			...
			{"Name" : "row_list_size", "Type" : "None", "Direction" : "I"},
			{"Name" : "trapezoid_edges_V", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_mSP_findLRBounds_fu_276.trapezoid_edges_V_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_35ns_33s_64_1_1_U20", "Parent" : "0"}]}
