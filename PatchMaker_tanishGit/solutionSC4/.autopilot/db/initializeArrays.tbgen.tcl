...
set C_modelArgList {
	{ patches_superpoints int 64 regular {array 240 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ patches_superpoints_address0 sc_out sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	patches_superpoints { ap_memory {  { patches_superpoints_address0 mem_address 1 8 }  { patches_superpoints_ce0 mem_ce 1 1 }  { patches_superpoints_we0 mem_we 1 1 }  { patches_superpoints_d0 mem_din 1 64 } } }
