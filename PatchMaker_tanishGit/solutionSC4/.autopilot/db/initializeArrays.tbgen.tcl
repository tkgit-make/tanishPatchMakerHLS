...
set C_modelArgList {
	{ patches_superpoints int 32 regular {array 2560 { 0 3 } 0 1 }  }
	{ patches_parameters int 32 regular {array 3840 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "patches_superpoints", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ patches_superpoints_d0 sc_out sc_lv 32 signal 0 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6404", "Max" : "6404"}
	, {"Name" : "Interval", "Min" : "6404", "Max" : "6404"}
]}
...
set Spec2ImplPortList { 
	patches_superpoints { ap_memory {  { patches_superpoints_address0 mem_address 1 12 }  { patches_superpoints_ce0 mem_ce 1 1 }  { patches_superpoints_we0 mem_we 1 1 }  { patches_superpoints_d0 mem_din 1 32 } } }
