...
set C_modelArgList {
	...
	{ index int 2 regular  }
	{ patches_superpoints int 64 regular {array 240 { 0 1 } 1 1 }  }
...
set portList { 
	...
	{ patches_superpoints_address0 sc_out sc_lv 8 signal 3 } 
	...
	{ patches_superpoints_address1 sc_out sc_lv 8 signal 3 } 
	{ patches_superpoints_ce1 sc_out sc_logic 1 signal 3 } 
	{ patches_superpoints_q1 sc_in sc_lv 64 signal 3 } 
	{ patches_parameters_address0 sc_out sc_lv 7 signal 4 } 
	...
	{ patches_parameters_address1 sc_out sc_lv 7 signal 4 } 
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "patches_parameters", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_delete_patch_patches_parameters_fu_208", "Port" : "patches_parameters"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_delete_patch_patches_parameters_fu_208", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	patches_superpoints { ap_memory {  { patches_superpoints_address0 mem_address 1 8 }  { patches_superpoints_ce0 mem_ce 1 1 }  { patches_superpoints_we0 mem_we 1 1 }  { patches_superpoints_d0 mem_din 1 64 }  { patches_superpoints_address1 MemPortADDR2 1 8 }  { patches_superpoints_ce1 MemPortCE2 1 1 }  { patches_superpoints_q1 MemPortDOUT2 0 64 } } }
