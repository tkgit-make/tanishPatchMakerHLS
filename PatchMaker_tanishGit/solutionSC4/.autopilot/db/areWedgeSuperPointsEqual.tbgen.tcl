...
set C_modelArgList {
	{ wsp2 int 64 regular {array 240 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ wsp2_address0 sc_out sc_lv 8 signal 0 } 
	{ wsp2_ce0 sc_out sc_logic 1 signal 0 } 
	{ wsp2_q0 sc_in sc_lv 64 signal 0 } 
	{ wsp2_address1 sc_out sc_lv 8 signal 0 } 
	{ wsp2_ce1 sc_out sc_logic 1 signal 0 } 
	{ wsp2_q1 sc_in sc_lv 64 signal 0 } 
	{ wsp1_offset1 sc_in sc_lv 3 signal 1 } 
	{ wsp2_offset3 sc_in sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "wsp2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "wsp2", "role": "address0" }} , 
 	...
 	{ "name": "wsp2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "wsp2", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	wsp2 { ap_memory {  { wsp2_address0 mem_address 1 8 }  { wsp2_ce0 mem_ce 1 1 }  { wsp2_q0 mem_dout 0 64 }  { wsp2_address1 MemPortADDR2 1 8 }  { wsp2_ce1 MemPortCE2 1 1 }  { wsp2_q1 MemPortDOUT2 0 64 } } }
