...
set C_modelArgList {
	...
	{ projectionToRow int 33 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "i", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "projectionToRow", "interface" : "wire", "bitwidth" : 33, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ row_list_size sc_in sc_lv 32 signal 257 } 
	{ projectionToRow sc_in sc_lv 33 signal 258 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "projectionToRow", "direction": "in", "datatype": "sc_lv", "bitwidth":33, "type": "signal", "bundle":{"name": "projectionToRow", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.trapezoid_edges_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2568_32_1_1_U327", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	mSP_findBounds {
		...
		projectionToRow {Type I LastRead 1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	projectionToRow { ap_none {  { projectionToRow in_data 0 33 } } }
}
