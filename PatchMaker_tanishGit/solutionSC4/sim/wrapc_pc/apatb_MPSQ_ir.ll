; ModuleID = 'C:/Users/rapiduser/Desktop/tanishGitHub/tanishPatchMakerHLS/PatchMaker_tanishGit/solutionSC4/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline
define internal void @onebyonecpy_hls.p0a5i32.625.626(i32* noalias align 512 "orig.arg.no"="0" %_0, i32* noalias align 512 "orig.arg.no"="0" %_1, i32* noalias align 512 "orig.arg.no"="0" %_2, i32* noalias align 512 "orig.arg.no"="0" %_3, i32* noalias align 512 "orig.arg.no"="0" %_4, [5 x i32]* noalias readonly "orig.arg.no"="1") #1 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a5i32.655.656([5 x i32]* %4, i32* align 512 %_0, i32* align 512 %_1, i32* align 512 %_2, i32* align 512 %_3, i32* align 512 %_4)
