...
attribute shreg_extract : string;
    ...
    signal empty_61_fu_10392_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_60_fu_10386_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_59_fu_10380_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    mux_128011_32_1_1_U13716 : component MPSQ_mux_128011_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    ap_phi_mux_i_04_phi_fu_10342_p4_assign_proc : process(i_04_reg_10338, ap_CS_fsm_pp0_stage0, i_reg_18230, icmp_ln620_reg_18235, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0)
    begin
    ...
    diff_fu_11782_p3 <= 
        ...
        ret_fu_11763_p2;
    empty_59_fu_10380_p2 <= "1" when (layer = ap_const_lv3_1) else "0";
    empty_60_fu_10386_p2 <= "1" when (layer = ap_const_lv3_2) else "0";
    empty_61_fu_10392_p2 <= "1" when (layer = ap_const_lv3_3) else "0";
    ...
    index_1_fu_11807_p3 <= 
        i_04_reg_10338_pp0_iter1_reg when (icmp_ln623_fu_11793_p2(0) = '1') else 
        index_reg_10350;
    ...
    newSel1280_fu_10412_p3 <= 
        GDn_points_read_27 when (empty_59_fu_10380_p2(0) = '1') else 
        GDn_points_read_30;
    ...
    newSel1284_fu_10440_p3 <= 
        ...
        GDn_points_read;
    newSel_fu_10398_p3 <= 
        GDn_points_read_29 when (empty_61_fu_10392_p2(0) = '1') else 
        GDn_points_read_28;
    or_cond1281_fu_10420_p2 <= (empty_fu_10374_p2 or empty_59_fu_10380_p2);
    or_cond1283_fu_10434_p2 <= (or_cond_fu_10406_p2 or or_cond1281_fu_10420_p2);
    or_cond_fu_10406_p2 <= (empty_61_fu_10392_p2 or empty_60_fu_10386_p2);
    ...
    zext_ln620_fu_10458_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_phi_mux_i_04_phi_fu_10342_p4),32));
end behav;
