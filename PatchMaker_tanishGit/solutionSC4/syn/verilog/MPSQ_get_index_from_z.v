...
wire   [0:0] icmp_ln579_fu_149_p2;
reg   [0:0] icmp_ln579_reg_258;
reg   [0:0] icmp_ln579_reg_258_pp0_iter1_reg;
reg   [0:0] icmp_ln579_reg_258_pp0_iter2_reg;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln579_reg_258 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter3 == 1'b1) & (icmp_ln579_reg_258_pp0_iter2_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln579_reg_258_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln579_reg_258 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln579_fu_149_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln579_reg_258 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
assign diff_fu_200_p3 = ((tmp_19_fu_192_p3[0:0] == 1'b1) ? sub_ln180_fu_186_p2 : ret_fu_181_p2);

assign i_fu_139_p2 = (ap_phi_mux_i_04_phi_fu_98_p4 + 8'd1);

assign icmp_ln579_fu_149_p2 = (($signed(zext_ln579_fu_145_p1) < $signed(GDn_points_load_reg_243)) ? 1'b1 : 1'b0);

assign icmp_ln582_fu_211_p2 = (($signed(sext_ln581_fu_208_p1) < $signed(minVal_reg_118)) ? 1'b1 : 1'b0);

assign idxprom_fu_130_p1 = layer;

assign index_1_fu_225_p3 = ((icmp_ln582_fu_211_p2[0:0] == 1'b1) ? i_04_reg_94_pp0_iter2_reg : index_reg_106);

assign minVal_1_fu_217_p3 = ((icmp_ln582_fu_211_p2[0:0] == 1'b1) ? sext_ln581_fu_208_p1 : minVal_reg_118);
