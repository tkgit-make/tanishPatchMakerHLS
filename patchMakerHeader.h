...
#define GDARRAY long (&GDarray) [MAX_LAYERS][MAX_POINTS_FOR_DATASET][PARAMETERS_PER_POINT], int (&GDn_points) [MAX_LAYERS]
#define GDARRAYPRESORT std::array<std::array<std::array<long, PARAMETERS_PER_POINT>, MAX_POINTS_FOR_DATASET>, MAX_LAYERS> &GDarray, int (&GDn_points) [MAX_LAYERS]
